// Taking necessary dom objects to manipulate
...
// Mapping skills with their price
const priceList = {
  photography: 200,
  ui: 300,
  ux: 300,
...
// all added prices will be stored here in order to be calculated later on
let data = [];
...
// Outputs prices on the client screen and stores in data variable
function addPrice(e) {
...
// Adds all prices from data variable and shows on the screen
function calculate() {
...
// Clears calculations and the screen
function clear() {
